...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('articles', function (Blueprint $table) {
            ...
            $table->enum('status', ['Pending', 'Approved', 'Rejected','Pending_committee','Send_to_editor','Not_approved','Committee_rejected','Pending_editor','Pending_Review'])->default('Pending'); // trang_thai -> status
