...
<body>
    ...
    <main class="ad_main">
        <section class="ad_search">
            <input type="text" id="searchInput" class="ad_search_input" placeholder="Tìm kiếm bài viết đã từ chối...">

        </section>
        <section class="ad_article_management">
            <h2>Bài viết đã từ chối</h2>
            <table class="ad_table">
                ...
                <tbody id="table-body">
                    <tr>
                        <td>2</td>
                        <td><a href="/admin/article-details" class="ad_article_link">Nghiên cứu về Machine
                                Learning</a></td>
                        <td>Trần Văn B</td>
                        <td>Đã từ chối</td>
                        <td>
