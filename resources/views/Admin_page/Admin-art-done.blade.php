...
<body>
    ...
    <main class="ad_main">
        <section class="ad_search">
            <input type="text" id="searchInput" class="ad_search_input"
                placeholder="Tìm kiếm bài viết đã hoàn thành...">

        </section>
        <section class="ad_article_management">
            <h2>Bài viết đã hoàn thành</h2>
            <table class="ad_table">
                ...
                <tbody id="table-body">
                    <tr>
                        <td>3</td>
                        <td><a href="/admin/article-details" class="ad_article_link">Ứng dụng AI trong Y học</a>
                        </td>
                        <td>Hoàng Văn C</td>
                        <td>Hoàn thành</td>
                        <td>
